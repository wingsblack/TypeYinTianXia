module xwz {
        ...
        $("#send_siliao_btn").unbind("click").bind("click", function (event) {
            ...
            if (text) {
                if (nowTalkUid) {
                    ...
                    Global.socket.send(Project.API_PRIVATE_CHAT + nowTalkUid, {}, text);
    ...
    export class PrivateChat {
        ...
        static talkto = talkto;

        static createUserTab = createUserTab;

        static activeUserTab = activeUserTab;
