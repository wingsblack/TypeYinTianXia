module xwz {
    ...
    var userlist: IUserDataMap = {}

    var dialog;

    export class User extends xwz.EventDispatcher{

        constructor() {
            super();

            this.API = Project.API_USER_EVENT;
        }
        API: string;
        ...
        static getAllUser() {
            xwz.Util.ajaxGet(xwz.Project.API_MEM_LIST, (data) => {
                this.appendUser(data.rows);
            });
        }

        static appendUser(rows) {
        ...
        login(loginName, password) {
            var _this = this;
            $.post(Project.API_USER_LOGIN, "loginName=" + loginName + "&password=" + password, function (data) {
                if (data.code == 0) {
                    //data = {
        ...
        RegisteredPrivateChat() {
            PrivateChat.API = Project.API_PRIVATE_CHAT_GET + this.id;
            Global.socket.RegisteredChat(xwz.PrivateChat);
        }
        ...
        setMenu() {
            ...
            menus.push({
                ...
                click: function (li, menu) {
                    ...
                    $.post(Project.API_HOST + '/app/account/updatebyadmin', data,
                        function () {
        ...
        send(text, obj = {}) {
            Global.socket.send(Project.API_PUBLIC_CHAT_SEND + Project.COMPANY_ID, obj, text);
        }
        ...
        check() {
            xwz.Util.ajaxGet(Project.API_HOST + '/home/me', function (data) {
        ...
        RegisteredEvent() {
            ...
            $('#login_form').on("submit", function () {
                ...
                Global.user.login(loginName, password);
            ...
            $("#bind_mobile").click(function () {
                ...
                art.dialog({
                    ...
                    esc: false,
                    init: function () {
                        if (Global.user.forceBindMobile == true) {
            ...
            $("#find_pwd_findcebox .getsmscode").click(function () {
                ...
                $.ajax({
                    url: Project.API_HOST + '/account/getSmsCode?newUser=false&captcha=' + captcha_v + '&mobile=' + mobile,
                    type: 'POST',
                    dataType: 'json',
                    success: function (data) {
                        if (data.code == 0) {
